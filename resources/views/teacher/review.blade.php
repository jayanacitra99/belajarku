                    ...
                    <?php $noAns = 1;?>
                        @foreach (unserialize($aLog->question) as $item)
                            ...
                            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                ...
                                <span class="mb-2 {{($correct === 'E') ? (($item['answer'] === $correct) ? 'text-success':'text-danger'):'text-dark'}} text-xs">E : <span class="{{($correct === 'E') ? (($item['answer'] === $correct) ? 'text-success':'text-danger'):'text-dark'}} font-weight-bold ms-sm-2">{{$item['optionE']}} {{($item['answer'] === 'E') ? '(Correct Answer)':''}}</span></span>
                                </div>
                            </li>
                            <?php $noAns++?>
                        @endforeach
